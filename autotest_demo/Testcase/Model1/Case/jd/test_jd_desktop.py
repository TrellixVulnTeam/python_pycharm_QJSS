...
from autotest_demo.Page.basePage import Page
from autotest_demo.Comm.Log import screen
from autotest_demo.Comm.data import read_excel
from autotest_demo.main import TestCasePath
...
PO_jd = 'autotest_demo.Page.jd.jd'
PO_search = 'autotest_demo.Page.jd.page_jd_search'
