...
# 请求参数
payload = {"phone": "17806533496", "password": "16a9e283c0de31705b00f8e04e1a2b4d", "remember": "1", "code": "",
           "area_code": "86"}
# form表单形式，参数用data
...
enter_res = session.post(url, data=payload, headers=headers)
...
customers_all_res = session.get(url, params=params, headers=headers)
